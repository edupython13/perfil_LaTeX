...
\begin{landscape}
	...
	\begin{longtable}{
		...
		|>{\centering\arraybackslash}m{0.17\availablewidth}           % PROCEDIMIENTO
		...
		|>{\raggedright\arraybackslash}m{0.13\availablewidth}|         % OBSERVACIONES
	}
		...
		AminoLab Forte & Aminoácidos, dextrosa, cloruro de potasio, cloruro de sodio, cloruro de calcio, acetato de sodio, vitamina B1 B2 	B6 	B12 & 1ml/1kg IV & \multirow{2}{=}{Cada 15 días} & \\
		\cline{4-6}
	...
	La tabla registra las desparasitaciones y aplicaciones de vitaminas realizadas en caninos durante el internado en el Hospital para Animales. Se documentaron 258 procedimientos: 8 desparasitaciones externas, 67 internas, 58 combinadas (interna y externa) y 125 aplicaciones de vitaminas y minerales. Los tratamientos incluyen antiparasitarios como Ranger (ivermectina), Levocan (levamisol), Basken (pamoato de pirantel y oxantel), Vermic total (praziquantel, pirantel pamoato, febantel) e Impacto (cipermetrina, clorpirifos, citronelal), antihistamínicos como Galerfin, y vitaminas como AminoLab Forte y Complejo B, administrados por vías oral, subcutánea, intramuscular o intravenosa, con frecuencias de 1 mes, 3 meses o cada 15 días, con resultados satisfactorios en todos los casos.
