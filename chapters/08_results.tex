...
\input{tables/02_bacteria}

\clearpage

\input{tables/03_metabolic}
...
\input{tables/08_desparasitar}

\clearpage

\input{tables/09_inmunizar}

\clearpage

\input{tables/10_servicios}
